...
export function getOrCreateAccount(id: string, createIfNotFound = true): Account {
...
export function getOrCreateAccountVaultBalance(id: string, createIfNotFound = true): AccountVaultBalance {
  // @ts-ignore: assign wrapper object to primitive
